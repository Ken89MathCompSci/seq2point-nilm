...
training_directory="datasets/microwave_training_.csv"
validation_directory="datasets/microwave_validation_.csv"

parser = argparse.ArgumentParser(description="Train sequence-to-point learning for energy disaggregation. ")

parser.add_argument("--appliance_name", type=remove_space, default="microwave", help="The name of the appliance to train the network with. Default is microwave. Available are: kettle, fridge, washing machine, dishwasher, and microwave. ")
...
parser.add_argument("--crop", type=int, default="25000", help="The number of rows of the dataset to take training data from. Default is 25000. ")
